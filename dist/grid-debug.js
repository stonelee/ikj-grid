...
define("ikj/grid/1.4.0/grid-debug.css", [], function() {
    seajs.importStyle('.oneline,.hd,.panel-hd,.grid-hd,.grid-cell{overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.mod,.hd,.panel-hd,.grid-hd,.bd,.panel-bd,.grid-bd,.panel-mod{position:relative;overflow:hidden}.panel-mod{margin-bottom:10px}.panel-hd{background-color:#307ecc;color:#FFF;font-size:14px;line-height:38px;padding-left:12px}.panel-bd{border:1px solid #ddd;background:#eff3f8}.grid-hd table,.grid-view table{table-layout:fixed;width:100%}.grid-hd th,.grid-view th{padding:0}.grid-hd{_width:100%;color:#707070;background:#f2f2f2;background:-webkit-gradient(linear,50% 0,50% 100%,color-stop(0%,#f8f8f8),color-stop(100%,#ececec));background:-webkit-linear-gradient(top,#f8f8f8,#ececec);background:-moz-linear-gradient(top,#f8f8f8,#ececec);background:-o-linear-gradient(top,#f8f8f8,#ececec);background:linear-gradient(top,#f8f8f8,#ececec)}.grid-hd .grid-cell{text-align:center;font-weight:700;border-bottom:1px solid #ddd}.grid-hd table{height:40px}.grid-bd{background:#fff}.grid-view{overflow:auto;_width:100%;height:100%}.grid-row:hover{background-color:#efefef}.grid-row-alt{background-color:#fafafa}.grid-row-is-selected,.grid-row-is-selected:hover{background-color:#dfe8f6}.grid-cell{padding:0 4px;border-width:0 1px 1px 0;border-style:dotted;border-color:#c5c5c5}.grid-mark-cell{background-color:#e3e4e6;text-align:center;border-bottom-style:solid}.grid-detail-cell{border-right-width:0}.grid-is-sortable,.grid-is-desc,.grid-is-asc{cursor:pointer}.grid-is-sortable:hover,.grid-is-desc:hover,.grid-is-asc:hover{color:#547ea8}.grid-is-desc,.grid-is-asc{color:#307ecc;background-color:#eaeef4;background:-webkit-gradient(linear,50% 0,50% 100%,color-stop(0%,#eff3f8),color-stop(100%,#e3e7ed));background:-webkit-linear-gradient(top,#eff3f8,#e3e7ed);background:-moz-linear-gradient(top,#eff3f8,#e3e7ed);background:-o-linear-gradient(top,#eff3f8,#e3e7ed);background:linear-gradient(top,#eff3f8,#e3e7ed)}.grid-is-sortable:after{content:"\\f0dc";display:inline-block;color:#555;font-family:FontAwesome;font-size:13px;font-weight:400;margin-right:4px;position:relative}.grid-is-asc:after{content:"\\f0de";top:4px;color:#307ecc}.grid-is-desc:after{content:"\\f0dd";top:-3px;color:#307ecc}.icon-grid-page-first,.icon-grid-page-last,.icon-grid-page-next,.icon-grid-page-prev{width:22px;height:22px;line-height:22px;text-align:center;margin:0 2px;border-radius:100%;color:gray;border:1px solid #ccc;background-color:#fff;cursor:pointer}.icon-grid-page-first:hover,.icon-grid-page-last:hover,.icon-grid-page-next:hover,.icon-grid-page-prev:hover{color:#699ab5;border-color:#699ab5}.icon-grid-page-first:before,.icon-grid-page-last:before,.icon-grid-page-next:before,.icon-grid-page-prev:before{color:gray}.icon-grid-page-first-disabled,.icon-grid-page-last-disabled,.icon-grid-page-next-disabled,.icon-grid-page-prev-disabled{width:22px;height:22px;line-height:22px;text-align:center;margin:0 2px;border-radius:100%;color:#b0b0b0;border:1px solid #ddd;background-color:#f7f7f7}.icon-grid-page-first:before,.icon-grid-page-first-disabled:before{content:"\\f100"}.icon-grid-page-last:before,.icon-grid-page-last-disabled:before{content:"\\f101"}.icon-grid-page-next:before,.icon-grid-page-next-disabled:before{content:"\\f105"}.icon-grid-page-prev:before,.icon-grid-page-prev-disabled:before{content:"\\f104"}.icon-grid-refresh{width:22px;height:22px;line-height:22px;text-align:center;margin:0 2px;border-radius:100%;cursor:pointer;opacity:.85;-webkit-transition:all,.12s;-moz-transition:all,.12s;-o-transition:all,.12s;transition:all,.12s}.icon-grid-refresh:hover{-webkit-transform:scale(1.2);-moz-transform:scale(1.2);-ms-transform:scale(1.2);-o-transform:scale(1.2);transform:scale(1.2);opacity:1}.icon-grid-refresh:before{content:"\\f021";color:#69aa46}.toolbar-text-right{float:right;margin-right:20px}.toolbar-ft{padding-left:10px;line-height:35px}.toolbar-ft .input{height:13px;display:inline-block;margin-top:5px;text-align:center}.toolbar-separator{border:1px solid #c9d4db;margin:4px}.panel-mod{width:100%!important}.grid-view .grid-cell:last-child{border-right:0}.loading{position:absolute;top:0;width:100%;height:100%;background:#fff;filter:alpha(Opacity=90);opacity:.9;z-index:100}.loading span{position:absolute;top:50%;left:50%;width:80px;height:20px;margin-left:-40px;margin-top:-40px;padding:10px 0;color:#3a87ad;line-height:20px;border:1px solid;text-align:center}.loading span i{margin-right:5px}');
});
